...
class RegisterAPIView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        verify_link = f"https://stock-prediction-portal-frontend-al-green.vercel.app/verify-email/?token={token}"
...
class PasswordResetRequestAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            reset_link = f"https://stock-prediction-portal-frontend-al-green.vercel.app/reset-password/{uidb64}/{token}/"
