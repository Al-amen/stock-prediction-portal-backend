...
class RegisterAPIView(generics.CreateAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        verify_link = f"https://stock-prediction-portal-frontend-alamen-i704wj1ai.vercel.app/verify-email/?token={token}"
...
class PasswordResetRequestAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            reset_link = f"https://stock-prediction-portal-frontend-alamen-i704wj1ai.vercel.app/reset-password/{uidb64}/{token}/"
